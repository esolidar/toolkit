...
import RequestDetailInfo from '../index';
...
describe('RequestDetailInfo component', () => {
  it('renders RequestDetailInfo correctly', () => {
    const component = shallow(<RequestDetailInfo request={request} />);
    expect(component).toHaveLength(1);
    expect(component.find('h3').length).toBe(4);
    expect(component.find('h4').length).toBe(6);
  });
});
