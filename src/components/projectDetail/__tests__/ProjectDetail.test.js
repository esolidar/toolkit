...
describe('ProjectDetail component', () => {
  ...
  it('should show answers with replies only', () => {
    const project = {
      whitelabel_id: 1,
      category_id: 1,
      project_category: {
    ...
    const component = shallow(<ProjectDetail project={project} lang="pt" serverlessResizeImage="https://image.testesolidar.com" />);
    expect(component.find('h4').length).toBe(4);
  });
  ...
  it('should show admin buttons', () => {
    ...
    const component = shallow(<ProjectDetail project={project} lang="pt" serverlessResizeImage="https://image.testesolidar.com" admin={admin} />);
