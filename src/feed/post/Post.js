...
const Post = ({
  ...
  if (+(post.as_company) === 1) {
    if (post.company) {
      thumb = post.company.thumbs.thumb ? post.company.thumbs.thumb : 'https://static.esolidar.com/frontend/assets/no-image.png';
    ...
    thumb = localStorage.user ? JSON.parse(localStorage.user).thumbs.thumb : 'https://static.esolidar.com/frontend/assets/no-image.png';
